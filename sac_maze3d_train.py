...
def main(argv):
    ...
    if config["game"]["save"]:
        ...
        if not config['game']['test_model']: #mpainei mesa
            total_games = experiment.max_episodes if loop == 1 else experiment.game  #osa kai ta epeisodia
